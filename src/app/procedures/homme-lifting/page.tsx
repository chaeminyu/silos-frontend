...
// 옴므리프팅 데이터
const hommeLiftingProcedures = [
  { 
    id: '01', 
    name: '남성 안면리프팅', 
    description: '남성의 얼굴 구조에 맞춘 전문적인 안면리프팅',
    duration: '3-4시간',
    features: ['남성전용', '자연스러움', '강인한인상']
  },
  { 
    id: '02', 
    name: '남성 목 리프팅', 
    description: '남성 목선과 턱선을 더욱 선명하고 강인하게 개선',
    duration: '2-3시간',
    features: ['목선강화', '턱선개선', '남성미향상']
  },
  { 
    id: '03', 
    name: '남성 이마리프팅', 
    description: '남성의 이마와 눈썹 라인을 자연스럽게 개선',
    duration: '1-2시간',
    features: ['이마개선', '눈썹라인', '젊은인상']
  },
  { 
    id: '04', 
    name: '남성 미니리프팅', 
    description: '최소 절개로 자연스러운 남성 얼굴 개선',
    duration: '1-2시간',
    features: ['최소절개', '빠른회복', '자연스러움']
  }
];

const hommeLiftingBenefits = [
  {
    number: '01',
    title: '남성 맞춤형',
    description: '남성의 얼굴 구조와 특성을 고려한 전문적인 리프팅'
  },
  {
    number: '02',
    title: '강인한 인상',
    description: '남성다운 강인하고 매력적인 인상으로 개선'
  },
  {
    number: '03',
    title: '자연스러운 결과',
    description: '과도하지 않은 자연스럽고 세련된 변화'
  },
  {
    number: '04',
    title: '사회적 신뢰도',
    description: '젊고 활력 넘치는 인상으로 사회적 신뢰도 향상'
  }
];

export default function HommeLiftingPage() {
  ...
  const handleAddToCart = (procedureId: string, procedureName: string, event: React.MouseEvent) => {
    ...
    if (!addedToCart.includes(procedureId)) {
      ...
      console.log(`Added to cart: 옴므리프팅 - ${procedureName}`);
    }
  };
  ...
  return (
    <PageLayout>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
          <div className="text-center text-white">
            ...
            <p className="text-xl font-elegant-sans font-light max-w-4xl mx-auto leading-relaxed text-white/90">
              강인하고 매력적인 남성미<br />
              세련되고 자연스러운<br />
              <span className="font-medium">남성 전용 리프팅</span>
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex overflow-x-auto gap-4 md:grid md:grid-cols-3 md:gap-6 pb-4">
              ...
              <div className="flex items-center space-x-4 p-6 bg-gradient-to-br from-cyan-50 to-white rounded-2xl flex-shrink-0 w-72 md:w-auto">
                ...
                <div>
                  ...
                  <p className="text-cyan-800 font-elegant-sans font-medium">국소/전신마취</p>
                </div>
              </div>
              <div className="flex items-center space-x-4 p-6 bg-gradient-to-br from-cyan-50 to-white rounded-2xl flex-shrink-0 w-72 md:w-auto">
                ...
                <div>
                  ...
                  <p className="text-cyan-800 font-elegant-sans font-medium">1-3주</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-16">
              ...
              <p className="text-xl font-elegant-sans font-light text-slate-700 leading-relaxed max-w-5xl mx-auto">
                남성의 얼굴 구조와 특성을 고려하여<br />
                강인하고 매력적인 남성미를 살린<br />
                <span className="font-medium text-cyan-600">남성 전용 리프팅 시술</span>입니다.
              </p>
            </div>

            {/* 4가지 장점 */}
            <div className="flex overflow-x-auto gap-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-6 mb-16 pb-4">
              {hommeLiftingBenefits.map((benefit, index) => (
            ...
            <div className="grid grid-cols-1 xl:grid-cols-5 gap-8 px-8">
                ...
                <div className="relative h-[500px] bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl border border-cyan-200/50 overflow-hidden sticky top-8">
                  <div className="flex items-center justify-center h-full">
                    <div className="text-center text-slate-700">
                      ...
                      <h3 className="text-2xl font-elegant font-medium mb-2">옴므리프팅</h3>
                      <p className="text-lg font-elegant-sans">강인하고 매력적인 남성미</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="xl:col-span-2">
                <div className="grid grid-cols-1 gap-3">
                  {hommeLiftingProcedures.map((procedure) => (
                    <div
                      key={procedure.id}
      ...
      <StandardConsultationSection
        title="옴므리프팅 상담 신청"
        description="전문 의료진과 함께 나에게 가장 적합한 남성 리프팅을 찾아보세요"
        initialProcedureId="homme-lifting"
      />
    </PageLayout>
  );
}