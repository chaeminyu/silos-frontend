            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10 text-center md:text-left">
              ...
              <div className="flex flex-col items-center md:items-start">
                ...
                <ul className="space-y-3 text-teal-smoke-400">
                  <li><a href="/procedures/silos-lifting" className="hover:text-teal-smoke-200 transition-colors font-elegant-sans font-light">실로스 실리프팅</a></li>
                  <li><a href="/procedures/forehead-lifting" className="hover:text-teal-smoke-200 transition-colors font-elegant-sans font-light">이마 눈썹 리프팅</a></li>
                  <li><a href="/procedures/under-eye-laser" className="hover:text-teal-smoke-200 transition-colors font-elegant-sans font-light">눈밑 지방레이저</a></li>
                  <li><a href="/procedures/silopat" className="hover:text-teal-smoke-200 transition-colors font-elegant-sans font-light">실로팻</a></li>
                </ul>
              </div>
