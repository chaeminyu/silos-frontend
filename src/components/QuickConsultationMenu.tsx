...
export default function QuickConsultationMenu() {
  ...
  return (
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-40">
      ...
      {/* 메인 메뉴 컨테이너 */}
      <div 
        className={`bg-white/10 backdrop-blur-xl border border-teal-smoke-200/30 shadow-2xl transition-all duration-500 ease-out ${
          isExpanded 
      ...
      >
        ...
        <div className="p-6 w-72">
          ...
          <div className="text-center mb-6">
            <h3 className="text-xl font-display font-light text-teal-smoke-800 mb-2 tracking-wide">
              상담 퀵 메뉴
            </h3>
                  ...
                  <div className={`bg-gradient-to-r ${option.color} rounded-2xl p-4 hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 border border-white/30`}>
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                        <IconComponent className="w-6 h-6 text-teal-smoke-800" />
                      </div>
                      <div className="flex-1">
                        <h4 className="font-elegant font-light text-teal-smoke-800 text-lg leading-tight mb-1">
                          {option.title}
                        </h4>
                        <p className="font-elegant-sans font-light text-teal-smoke-700 text-sm">
                          {option.description}
                        </p>
                      </div>
                      <ChevronRight className="w-4 h-4 text-teal-smoke-600 group-hover:translate-x-1 transition-transform" />
                    </div>
                  </div>
                </a>
              );
          ...
          <div className="mt-6 pt-4 border-t border-teal-smoke-200/30">
            <div className="text-center">
              <p className="font-elegant-sans font-light text-teal-smoke-600 text-sm leading-relaxed">
                평일 09:00-18:00<br />
                토요일 09:00-14:00
              </p>
            </div>
